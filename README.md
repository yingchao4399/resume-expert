...
- V6 JSON 备份会异步汇总 localStorage 与 IndexedDB，并保存 JD 需求地图 revision、匹配依据和岗位准备度，继续兼容 V1–V5。
...
本版使用业务文档 Schema 8、文档库 Schema 9、备份 V5。旧分析仍可查看，但因缺少 requirementId 会锁定；重新分析后才能继续制作与交付。
